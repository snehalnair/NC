...
<div style='padding:24px 32px 18px 32px;margin-bottom:8px;'>
  <div style='font-size:1.35em;font-weight:800;color:#2c3e50;line-height:1.35;margin-bottom:10px;letter-spacing:0.12em;text-transform:uppercase;'>Neuro-AI Cognitive Companion</div>
  <div style='font-size:1.1em;color:#2c3e50;font-weight:800;margin-bottom:12px;'>
